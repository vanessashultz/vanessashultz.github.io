    ...
    <div className="max-h-sm w-full lg:w-1/2 rounded-xl overflow-hidden shadow-lg bg-offWhite">
      <div className="px-6 py-4">
        ...
        <div className="font-bold text-xl pt-8 font-gerhause">
          Presentation Director with{" "}
          <a
            href="https://codingandcocktails.kcwomenintech.org/#mentors"
            target="_blank"
        ...
        <ul className="text-sm">
          <li className="py-2">
            Teach fundamental coding principles in monthly interactive sessions
            to excite women about technology and increase diversity in the
            field.
          </li>
        </ul>
