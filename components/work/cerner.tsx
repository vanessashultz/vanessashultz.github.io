  ...
  return (
    <div className="max-h-sm w-full lg:w-1/2 rounded-xl overflow-hidden shadow-lg bg-offWhite">
      <div className="px-6 py-4">
        ...
        <div className="font-bold text-xl pt-8 font-gerhause">Software Engineer Intern</div>
        ...
        <ul className="text-sm">
          ...
          <li className="py-2">
            Validated new and existing code, which increased project&apos;s unit testing coverage by 20%.
          </li>
        </ul>
        <h3 className="text-lg font-bold pt-5">Awards:</h3>
        <ul className="text-sm">
          <li className="py-2">
            <span className="font-bold text-blue-dark">ShipIt Coding Competition: Intern 2nd Place and Company-wide Runner-up</span>
