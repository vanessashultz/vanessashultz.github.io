...
const svg = {
  light: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="inline-block h-6 w-6">
...
const ThemeSwitcher: React.FC = (): JSX.Element => {
  ...
  return (
    <>
      <div className="z-[9999]" id="theme-switcher" ref={switcher}>
        <div className="relative">
          <button
            ...
            id="themeSwitcher"
            aria-expanded="false"
            onClick={activeTheme === 'light' ? () => setDarkTheme() : () => setLightTheme()}
          >
